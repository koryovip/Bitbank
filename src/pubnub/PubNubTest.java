...
public class PubNubTest {
        ...
        pubnub.addListener(new SubscribeCallback() {
            ...
            public void message(PubNub pubnub, PNMessageResult message) {
                try {
                    ...
                    if ("candlestick_xrp_jpy".equals(channel)) {
                        ...
                        System.out.println(hoge);
                    } else if ("transactions_xrp_jpy".equals(channel)) {
    ...
    public void watchChannel() {
         ...
         */
        pubnub.subscribe().channels(Arrays.asList("candlestick_xrp_jpy", "depth_xrp_jpy", "transactions_xrp_jpy")) // subscribe to channels
                .execute();
    }
